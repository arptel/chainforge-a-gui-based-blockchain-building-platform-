...
class MyStorageWrapper(SmartContract):
    def __init__(self):
        super().__init__("contract_123", "sk_test_123")
...
class Client:
    def __init__(self, base_url=None):
        ...
        self.MyStorage = MyStorageWrapper()
        self.MyToken = SmartContract('contract_456', 'sk_test_456')
