...
import { verifyCertificate, getCertificate } from '@/lib/api';
                        ...
                        <div className="flex-1">
                            ...
                            {certData && result.isValid && (
                                <div className="mt-6 pt-6 border-t border-white/10 grid grid-cols-2 gap-y-4 gap-x-8">
                                    <div>
                                        <span className="text-xs text-emerald-500/70 font-bold uppercase tracking-wider mb-1 flex items-center gap-1"><User className="w-3 h-3" /> Candidate Name</span>
                                        <p className="text-lg font-medium text-white">{certData.student_name}</p>
                                    </div>
                                    <div>
                                        <span className="text-xs text-emerald-500/70 font-bold uppercase tracking-wider mb-1 flex items-center gap-1"><Award className="w-3 h-3" /> Degree</span>
                                        <p className="text-lg font-medium text-white">{certData.degree}</p>
                                    </div>
                                    <div>
                                        <span className="text-xs text-emerald-500/70 font-bold uppercase tracking-wider mb-1 flex items-center gap-1"><Calendar className="w-3 h-3" /> Graduation Year</span>
                                        <p className="text-lg font-medium text-white">{certData.year}</p>
                                    </div>
                                    <div>
                                        <span className="text-xs text-emerald-500/70 font-bold uppercase tracking-wider mb-1 flex items-center gap-1"><Building className="w-3 h-3" /> Issuing Authority</span>
